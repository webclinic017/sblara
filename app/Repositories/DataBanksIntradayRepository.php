...
$returnData=array();
    ...
    public static function getLastDayIntraForPlugin2($last_update_time = 0, $max_id = 0)
    {
       ...
       // return $rawdata;
        ...
        $returnData['intraday']= $intraday;
        $returnData['eod']= $eod;
        $returnData['new_max_id']= $new_max_id;
