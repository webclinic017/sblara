...
(data_banks_intradays.total_value/data_banks_intradays.total_trades)*1000000 as big_buy,
instrument_id,
(
 ...
 WHERE
 data_banks_intradays.batch=$batch_id and instruments.sector_list_id!=23 and instrument_id != 10006 and
