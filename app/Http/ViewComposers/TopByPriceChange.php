...
class TopByPriceChange
{
    ...
    public function compose(View $view)
    {
        ...
        $topList=DataBanksIntradayRepository::significantValue2Days('close_price',10);
        //dd($topList->toArray());
        ...
        $viewData['inlinesparkline']='inlinesparkline_topbypricechage';
