...
class ApiController extends Controller
{
    public function symbol_list()
    {
	 ...
	 public function eod_data($from, $to, $instrument_code, $adjusted = 1) {
	    $data = DataBankEodRepository::getPluginEodData($instrument_code, $from, $to, $adjusted);
	    return json_encode($data, JSON_UNESCAPED_SLASHES);
	}

	public function eod_data_all($from, $to, $adjusted = 1, $instrument_codes = null) {
	...
	public function intraday_data($minute = 1, $tradeDate = null, $instrument_codes = null) {
	...
	public function intraday_data_lastday($last_update_time = 0, $instrument_code = null) {
	    $data = DataBanksIntradayRepository::getLastDayIntraForPlugin($last_update_time, $instrument_code);
	    return $data;
	}

	public function fundamental_data($instrument_code = null) {
...
public function plugin_user_stats($username, $hdd, $cpu) {
