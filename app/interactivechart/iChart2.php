...
<applet name="FnChartsApplet1" width="960" height="590" codebase="fncharts" code="FnChartsApplet.class" archive="fncharts.jar" mayscript="true">
  ...
  <param name="DataSource" value="data/get_eod_data.php?symbol={SYMBOL}&adjusted={ADJUSTED}&timeframe={Timeframe}&first_timestamp={FirstDataTimestamp}&last_timestamp={LastDataTimestamp}">
  ...
  <param name="ADJUSTED" value="<?=$_REQUEST['adjusted']?>">
