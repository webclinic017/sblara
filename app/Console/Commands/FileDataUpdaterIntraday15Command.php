...
class FileDataUpdaterIntraday15Command extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'dse:FileDataUpdaterIntraday15';
     ...
     * @var string
     */
    protected $description = 'Updating intraday 15 minutes file data';
...
// live server command   /opt/cpanel/ea-php70/root/usr/bin/php /home/hostingmonitors/artisan dse:FileDataUpdaterIntraday15
                    ...
                    if (count($instrument_info)) {
                      ...
                      //  if($trade_date != $activeTradeDates->trade_date)
                       //     continue;
                        ...
                        $file_path = "data/$instrument_id/intraday/15_minutes/latest/v.txt";
                        ...
                        $file_path = "data/$instrument_id/intraday/15_minutes/latest/o.txt";
                        if (Storage::disk('local')->exists($file_path))
                        {
                        ...
                        $file_path = "data/$instrument_id/intraday/15_minutes/latest/h.txt";
                        if (Storage::disk('local')->exists($file_path))
                        {
                        ...
                        $file_path = "data/$instrument_id/intraday/15_minutes/latest/l.txt";
                        if (Storage::disk('local')->exists($file_path))
                        {
                        ...
                        $file_path = "data/$instrument_id/intraday/15_minutes/latest/d.txt";
                        if (Storage::disk('local')->exists($file_path))
                        {
