...
class IntradayData1MinutesCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'filter:IntradayData1MinutesCommand';
...
// live server command   /opt/cpanel/ea-php70/root/usr/bin/php /home/stock/sbdev/artisan filter:IntradayData1Minutes
...
where lm_date_time >= DATE_SUB(NOW(),INTERVAL 3 DAY) and instrument_id=$instrument_id and markets.id = data_banks_intradays.market_id
ORDER BY lm_date_time asc ,total_volume asc";
                ...
                if (count($all_data)) {
                    ...
                    $file_path = "data/$instrument_id/intraday/1_minutes/unadjusted";
