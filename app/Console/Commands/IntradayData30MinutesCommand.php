...
class IntradayData30MinutesCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'filter:IntradayData30MinutesCommand';
     ...
     * @var string
     */
    protected $description = '30 Minute adjusted data writing to file';
...
// live server command   /opt/cpanel/ea-php70/root/usr/bin/php /home/stock/sbdev/artisan filter:IntradayData30Minutes
...
where lm_date_time >= DATE_SUB(NOW(),INTERVAL 45 DAY) and instrument_id=$instrument_id and markets.id = data_banks_intradays.market_id
ORDER BY lm_date_time asc ,total_volume asc";
                ...
                if (count($all_data)) {
                    ...
                    $file_path = "data/$instrument_id/intraday/30_minutes/unadjusted";
