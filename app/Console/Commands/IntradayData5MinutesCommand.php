...
class IntradayData5MinutesCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'filter:IntradayData5MinutesCommand';
     ...
     * @var string
     */
    protected $description = '5 Minute adjusted data writing to file';
...
// live server command   /opt/cpanel/ea-php70/root/usr/bin/php /home/stock/sbdev/artisan filter:IntradayData5Minutes
...
where lm_date_time >= DATE_SUB(NOW(),INTERVAL 10 DAY) and instrument_id=$instrument_id and markets.id = data_banks_intradays.market_id
ORDER BY lm_date_time asc ,total_volume asc";
                ...
                if (count($all_data)) {
                    ...
                    $file_path = "data/$instrument_id/intraday/5_minutes/unadjusted";
