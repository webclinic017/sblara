...
Route::get('eod_data_all/{from}/{to}/{adjusted?}/{instrument_codes?}', function ($from, $to, $adjusted = 1, $instrument_codes = null) {
    ...
    $heading = "$time eod_data_all | from=$from to=$to instrument_code=$instrument_codes adjusted=$adjusted";
    Storage::append($file, $heading);*/
    ...
    $data = \Cache::remember("plugin_eod_data_all". $instrument_codes.'_'.$adjusted.$from.$to, 1, function () use ($from, $to, $adjusted, $instrument_codes)
    {
//$tradeDate=2017-05-29

    /*    $file = "plugin/log.txt";
        $time2=date('d-M-Y h:i:s');
        $heading = "$time2 eod_data_all from database ===================";
        Storage::append($file, $heading);*/
...
Route::get('intraday_data/{minute?}/{tradeDate?}/{instrument_code?}', function ($minute = 1, $tradeDate = null, $instrument_codes = null) {
 ...
 /*   $file = "plugin/log.txt";
    $heading = "intraday_data | minute=$minute tradeDate=$tradeDate instrument_code=$instrument_codes";
    Storage::append($file, $heading);*/
...
Route::get('intraday_data_lastday/{last_update_time?}/{instrument_code?}/', function ($last_update_time = 0, $instrument_code = null) {
  ...
  /*  $file = "plugin/log.txt";
    $heading = "intraday_data_lastday | last_update_time=$last_update_time  instrument_code=$instrument_code";
    Storage::append($file, $heading);*/
