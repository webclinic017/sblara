...
<div class="row">
                            <div class="col-md-12">
<img src="/img/amibroker_data_feed_bannar.png" />
                            </div>
                        </div>
...
<div class="portlet light portlet-fit bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject font-green bold uppercase">Package</span>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="price-column-container border-active">
                                                ...
                                                <div class="price-table-pricing">
                                                    <h3>
                                                        <sup class="price-sign">BDT</sup>00</h3>
                                                    <p>per month</p>
                                                </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="price-column-container border-active">
                                                ...
                                                <div class="price-table-pricing">
                                                    <h3>
                                                        <sup class="price-sign">BDT</sup>1000</h3>
                                                    <p>per month</p>
                                                </div>
                                                <div class="price-table-content">
                                                                                                    <div class="row mobile-padding">
                                        ...
                                        <div class="col-md-3">
                                            <div class="price-column-container border-active">
                                                ...
                                                <div class="price-table-pricing">
                                                    <h3>
                                                        <sup class="price-sign">BDT</sup>2500</h3>
                                                    <p>per month</p>
