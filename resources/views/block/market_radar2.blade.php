<div class="row widget-row">
    <div class="col-md-6">
        ...
        <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
            <h4 class="widget-thumb-heading">Paid up 0 to 100 M</h4>
            <div class="widget-thumb-wrap">
                <i class="widget-thumb-icon bg-green icon-bulb"></i>
                <div class="widget-thumb-body">
                    <span class="widget-thumb-subtitle">up</span>
                    <span class="widget-thumb-body-stat" data-counter="counterup" data-value="85">85%</span>
                </div>
            </div>
        </div>
        <!-- END WIDGET THUMB -->
