@php 
$instrumentInfo = (Object) ['id' => $instrument_id, 'instrument_code' => $instrument_code];
@endphp
<div class="col-lg-6 col-md-3 col-sm-6 col-xs-12">
<a target="_blank" href="{{ url('company-details/') }}/{{$instrumentInfo->id}}" class="btn green-sharp btn-block btn-outline sbold uppercase">Company details of {{$instrumentInfo->instrument_code}} </a>
</div>
