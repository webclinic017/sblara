...
<script src="{{ URL::asset('metronic/assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js') }}"></script>
<script src="{{ URL::asset('metronic/assets/global/plugins/bootstrap-timepicker/js/bootstrap-timepicker.min.js') }}"></script>
<script src="{{ URL::asset('metronic/assets/global/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js') }}"></script>
<script src="{{ URL::asset('metronic/assets/global/plugins/clockface/js/clockface.js') }}"></script>
<script src="{{ URL::asset('metronic/assets/pages/scripts/components-date-time-pickers.min.js') }}"></script>
...
maxboostedstep: 10000000
    ...
    function loadChart(el) {
       ...
       /* App.blockUI({
        ...
        var url = "http://www.new.stockbangladesh.com/TechnicalAnalysis/chart_img_trac2/";
