<div id="T3">
    <div class="alert alert-warningdf alert-dismissable" data-func="T3">
        <div class="row">
        <div class="col-md-12">

         <label class="col-md-2 control-label" for="form_control_1">T3 </label>
                <form class="form-inline" role="form">
                    ...
                    <div class="form-group form-md-line-input">
                        <input class="form-control " data-param="2" placeholder="VFactor" type="number" max="1" value="1" style="width: 55px"> {{-- validation 2 to 100--}}
                        <div class="form-control-focus"> </div>
                    </div>
