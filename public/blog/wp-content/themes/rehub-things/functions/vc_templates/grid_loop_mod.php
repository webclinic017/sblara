<?php 
	$post_formats = $module_pagination = $data_source = $cat = $ids = $orderby = $order = $meta_key = $show = $offset = $columns = $grid_type = '';
	...
	$infinitescrollwrap = ($module_pagination =='3') ? ' inf_scr_wrap_auto' : '';    
?>
...
<?php if ($grid_type =='def') :?>
    ...
    <div class="fourth-col-gridhub<?php echo $infinitescrollwrap ;?>">    
    <?php else : ?>
    <div class="two-col-gridhub<?php echo $infinitescrollwrap ;?>">
    <?php endif ;?> 
    ...
    <?php elseif ($module_pagination == '2') :?>    
        <div class="more_post onclick index_next_pagination"><?php echo get_next_posts_link('' . __('More posts', 'rehub_framework') . ''); ?></div>
