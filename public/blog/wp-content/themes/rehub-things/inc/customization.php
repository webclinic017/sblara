<style type="text/css">		 
    ...
    <?php if(rehub_option('rehub_btnofferinside_color') !='') : ?>
		.rehub_feat_block .priced_block a.btn_offer_block, .offer_grid .priced_block a.btn_offer_block, .rehub_feat_block .priced_block a.btn_offer_block:hover, .offer_grid .priced_block a.btn_offer_block:hover{background-color: <?php echo rehub_option('rehub_btnofferinside_color') ?>;}
	<?php endif; ?>	
...
article.post a.color_link{ color: <?php echo $colorschema; ?> !important;}
...
/*BGS*/
.overlay_post_formats.review_formats_score, .rate_bar_wrap .review-top .overall-score, .rate_bar_wrap_two_reviews .user-review-criteria .rate-bar-bar, .rate-bar-bar, #reviews_tabs .more, #home_carousel .controls:hover, .woocommerce .widget_price_filter .ui-slider .ui-slider-handle, .woocommerce-page .widget_price_filter .ui-slider .ui-slider-handle, .widget_edd_cart_widget .edd-cart-number-of-items .edd-cart-quantity, .btn_more:hover, #reviews_tabs > ul > li.current, #reviews_tabs > ul > li:hover, .main_slider .flex-overlay a.read-more:hover, .main_slider .flex-overlay:hover a.read-more, .featured_slider:hover .score, .priced_block a.btn_offer_block , #bbp_user_edit_submit, .bbp-topic-pagination a, .bbp-topic-pagination a, nav.top_menu > ul > li.current-menu-item, .title_deal_wrap, .woobtn_offer_block, input.mdf_button, .dl-menuwrapper button:hover, .dl-menuwrapper button.dl-active, .widget.tabs > ul > li:hover, .wps-members > strong:first-child , .custom-checkbox label.checked:after, .def-carousel.sec_style_carousel .carousel-next:hover, .def-carousel.sec_style_carousel .carousel-prev:hover, .post_slider .caption, .slider_post .caption, .post .btn:hover, .small_post .btn:hover, ul.postpagination li.active a, ul.postpagination li:hover a, ul.postpagination li a:focus, .quick_view_btn a:hover, .custom-radio label.checked:after, .post_slider .flex-control-nav li a.flex-active, .post_slider .flex-control-nav li a:hover, .top_theme h5 strong, #home_carousel .text:after, #topcontrol:hover, .featured_slider .flex-control-paging li a.flex-active, .featured_slider .flex-control-paging li a:hover { background: <?php echo $colorschema; ?>; }

/*color*/
.flexslider .fa-pulse, .userstar-rating span:before, ul.page-numbers li.current a, ul.page-numbers li:hover a, ul.page-numbers li:focus a, ul.page-numbers li.active a, .comment-reply-link, .footer-bottom .widget .f_menu li a:hover, .comment_form h3 a, .bbp-body li.bbp-forum-info > a:hover, .bbp-body li.bbp-topic-title > a:hover, #subscription-toggle a:before, #favorite-toggle a:before, .aff_offer_links .aff_name a, .rehub_feat_block .start_price span, .news_lettr p a, .sidebar .featured_slider .link, .commentlist .comment-content small a, .related_articles .title_cat_related a, .heading a, article em.emph, .best_from_cat_carousel h5 a, .campare_table table.one td strong.red, .sidebar .tabs-item .detail p a, .category_tab h5 a:hover, .sidebar .widget p a, .footer-bottom .widget .title_b span, footer p a, .welcome-frase strong { color: <?php echo $colorschema; ?>; }
