...
return array(
	'id'          => 'mag_builder_page',
	'types'       => array('page'),
	'title'       => __('Page block builder', 'rehub_child'),
	'priority'    => 'high',
	    ...
	    array(
			...
			'fields'    => array(
			    ...
			    array(
					...
					'sortable'  => false,
					'name'      => 'two_col_news',
					'title'     => __('Two column news block', 'rehub_child'),
					'dependency' => array(
					...
					'fields'    => array(
						...
						array(
							...
							'label' => __('Choose category for 1 column', 'rehub_child'),
						...
						array(
							...
							'label' => __('Choose post formats for 1 column', 'rehub_child'),
						...
						array(
							...
							'label' => __('Offset for 1 col', 'rehub_child'),
							'description' => __('Number of posts to offset for first column  or leave blank', 'rehub_child'),
							'default' => '',
							'validation' => 'numeric',
						),											
						...
						array(
							...
							'label' => __('Choose category for 2 column', 'rehub_child'),
						...
						array(
							...
							'label' => __('Choose post formats for 2 column', 'rehub_child'),
						...
						array(
							...
							'label' => __('Offset for 2 col', 'rehub_child'),
						...
						array(
							...
							'label' => __('Enable title of box?', 'rehub_child'),
						),						
						...
						array(
							...
							'label' => __('Title of block', 'rehub_child'),
							'description' => __('Set title of block (use short titles)', 'rehub_child'),
							'dependency' => array(
						...
						array(
							...
							'label' => __('Choose style of title', 'rehub_child'),
							'description' => __('Choose position and style of title', 'rehub_child'),
							'items' => array(
								'data' => array(
									array(
										'source' => 'function',
						...
						array(
							...
							'label' => __('Custom URL Text:', 'rehub_child'),
							'description' => __('Set text of url near title', 'rehub_child'),
							'dependency' => array(
                                 'field' => 'two_col_news_module_toggle_title',
                                 'function' => 'vp_dep_boolean',
                            ),							
						...
						array(
							...
							'label' => __('Custom URL:', 'rehub_child'),
							'description' => __('Set url with http://', 'rehub_child'),
							'dependency' => array(
                                 'field' => 'two_col_news_module_toggle_title',
                                 'function' => 'vp_dep_boolean',
                            ),							
			    ...
			    array(
					...
					'sortable'  => false,
					'name'      => 'gal_carousel',
					'title'     => __('Photo gallery', 'rehub_child'),
					'dependency' => array(
						'field'    => 'rehub_framework_pb',
						...
						array(
							...
							'fields'    => array(
								array(
									...
									'label' => __('Upload the Image Here', 'rehub_child'),
									'default' => '',
								),
							    array(
							        'type' => 'textbox',
							        'name' => 'gal_carousel_url',
							        'label' => __('Set url', 'rehub_child'),
							        'description' => __('Set url on image or leave blank', 'rehub_child'),
							        'validation' => 'url',
							    ),								
							),
						),						
			    ...
			    array(
					...
					'sortable'  => false,
					'name'      => 'video_mod',
					'title'     => __('Video news block', 'rehub_child'),
					'dependency' => array(
						'field'    => 'rehub_framework_pb',
					...
					'fields'    => array(
						...
						array(
							...
							'label' => __('Choose tag for block', 'rehub_child'),
							'description' => __('Choose tag from which to display content in block or leave blank', 'rehub_child'),
							'items' => array(
								'data' => array(
									array(
										'source' => 'function',
			    ...
			    array(
					...
					'sortable'  => false,
					'name'      => 'tab_mod',
					'title'     => __('Tabbed block', 'rehub_child'),
					'dependency' => array(
						'field'    => 'rehub_framework_pb',
					...
					'fields'    => array(
						...
						array(
							'type' => 'select',
							'name' => 'tab_mod_cats_1',
							'label' => __('Choose category for 1 tab', 'rehub_child'),
						...
						array(
							'type' => 'textbox',
							'name' => 'tab_mod_name_1',
							'label' => __('Choose name for 1 tab', 'rehub_child'),
						...
						array(
							'type' => 'select',
							'name' => 'tab_mod_cats_2',
							'label' => __('Choose category for 2 tab', 'rehub_child'),
						...
						array(
							'type' => 'textbox',
							'name' => 'tab_mod_name_2',
							'label' => __('Choose name for 2 tab', 'rehub_child'),
							'description' => __('Note, name must be maximum 12 symbols', 'rehub_child'),
							'validation' => 'maxlength[15]',
						),
						...
						array(
							'type' => 'select',
							'name' => 'tab_mod_cats_3',
							'label' => __('Choose category for 3 tab', 'rehub_child'),
						...
						array(
							'type' => 'textbox',
							'name' => 'tab_mod_name_3',
							'label' => __('Choose name for 3 tab', 'rehub_child'),
							'description' => __('Note, name must be maximum 12 symbols', 'rehub_child'),
							'validation' => 'maxlength[15]',
						),
						...
						array(
							'type' => 'select',
							'name' => 'tab_mod_cats_4',
							'label' => __('Choose category for 4 tab', 'rehub_child'),
						...
						array(
							'type' => 'textbox',
							'name' => 'tab_mod_name_4',
							'label' => __('Choose name for 4 tab', 'rehub_child'),
							'description' => __('Note, name must be maximum 12 symbols', 'rehub_child'),
							'validation' => 'maxlength[15]',
						),
			    ...
			    array(
					...
					'title'     => __('Blog posts with small thumbs', 'rehub_child'),
					'dependency' => array(
						'field'    => 'rehub_framework_pb',
					...
					'fields'    => array(
						...
						array(
							...
							'label' => __('Exclude Categories', 'rehub_child'),
							'description' => __('Choose categories that you\'d like to exclude from blog stream', 'rehub_child'),
							'items' => array(
								'data' => array(
									array(
										'source' => 'function',
						...
						array(
							...
							'label' => __('Or Include Category', 'rehub_child'),
							'description' => __('Choose parent category that you\'d like to include to stream. Or leave blank both fields to show posts from all categories', 'rehub_child'),
							'items' => array(
								'data' => array(
									array(
										'source' => 'function',
						...
						array(
							...
							'label' => __('Choose post formats for block', 'rehub_child'),
							'description' => __('Choose post formats to display in block or leave blank to display all', 'rehub_child'),
							'items' => array(
								'data' => array(
									array(
										'source' => 'function',
						...
						array(
							...
							'label' => __('Fetch Count', 'rehub_child'),
							'description' => __('How much posts you\'d like to display in 1 page?', 'rehub_child'),
							'default' => '5',
							'validation' => 'numeric',
						),
						...
						array(
							...
							'label' => __('Offset for block', 'rehub_child'),
							'description' => __('Enter number of posts to offset or leave blank', 'rehub_child'),
							'default' => '',
							'validation' => 'numeric',
						),						
						...
						array(
							...
							'label' => __('Enable pagination?', 'rehub_child'),
						),						
			    ...
			    array(
					...
					'title'     => __('Regular blog posts', 'rehub_child'),
					'dependency' => array(
						'field'    => 'rehub_framework_pb',
			    ...
			    array(
					...
					'sortable'  => false,
					'name'      => 'grid_loop_mod',
					'title'     => __('Grid style posts', 'rehub_child'),
					'dependency' => array(
						'field'    => 'rehub_framework_pb',
					...
					'fields'    => array(
						...
						array(
							...
							'items' => array(
								...
								array(
									'value' => '2',
									'label' => __('New item will be added by click', 'rehub_child'),
								),
								array(
									'value' => 'no',
			    ...
			    array(
					...
					'title'     => __('News block with thumbs', 'rehub_child'),
					'dependency' => array(
						'field'    => 'rehub_framework_pb',
			    ...
			    array(
					...
					'title'     => __('News block without small thumbs', 'rehub_child'),
					'dependency' => array(
						'field'    => 'rehub_framework_pb',
			    ...
			    array(
					...
					'title'     => __('Posts carousel block', 'rehub_child'),
					'dependency' => array(
						'field'    => 'rehub_framework_pb',
					...
					'fields'    => array(
						...
						array(
							...
							'label' => __('Choose post formats for carousel', 'rehub_child'),
			    ...
			    array(
					...
					'sortable'  => false,
					'name'      => 'slider_mod',
					'title'     => __('Posts slider block', 'rehub_child'),
					'dependency' => array(
						'field'    => 'rehub_framework_pb',
			    ...
			    array(
					...
					'sortable'  => false,
					'name'      => 'custom_mod',
					'title'     => __('Custom block', 'rehub_child'),
					'dependency' => array(
						'field'    => 'rehub_framework_pb',
					...
					'fields'    => array(
						 ...
						 array(
							...
							'label' => __('Custom code', 'rehub_child'),
							'description' => __('Insert your custom code (adsense ads, banner, etc.)', 'rehub_child'),
							'default' => '',
						),
						...
						array(
							...
							'label' => __('Enable box border?', 'rehub_child'),
						),										
			    ...
			    array(
					...
					'sortable'  => false,
					'name'      => 'woo_mod',
					'title'     => __('Woo commerce product carousel', 'rehub_child'),
					'dependency' => array(
						'field'    => 'rehub_framework_pb',
					...
					'fields'    => array(
						...
						array(
							'type' => 'slider',
							'name' => 'woo_mod_fetch',
							'label' => __('Number of products to display', 'rehub_child'),
							'min' => '4',
							'max' => '10',
							'step' => '1',
							'default' => '4',
						 ...
						 array(
							'type' => 'select',
							'name' => 'woo_mod_type',
							'label' => __('Type of products to display in block', 'rehub_child'),
							'items' => array(
								array(
									'value' => 'latest',
									'label' => __('Latest products', 'rehub_child'),
								),
								array(
									'value' => 'featured',
									'label' => __('Featured products', 'rehub_child'),
								),
								array(
									'value' => 'best',
									'label' => __('Best sellers', 'rehub_child'),
								),
							),
							'default' => array(
							'latest',
						...
						array(
							'type' => 'textbox',
							'name' => 'woo_cat',
							'label' => __('Set category', 'rehub_child'),
