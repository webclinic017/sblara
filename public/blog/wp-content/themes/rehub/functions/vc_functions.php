...
//POST SLIDER BLOCK
vc_map( array(
    "name" => __('Posts slider block', 'rehub_framework'),
...
vc_map( array(
    ...
    "params" => array(
        array(
            "type" => "textfield",
            "heading" => __('Offer price :', 'rehub_framework'),
            "admin_label" => true,
            "param_name" => "price",
        ),	
        array(
            "type" => "textfield",
            "heading" => __('Button link :', 'rehub_framework'),
        ...
        array(
            "type" => "textfield",
            "heading" => __('Title of offer :', 'rehub_framework'),
            "admin_label" => true,
            "param_name" => "title",
        ),
        array(
            "type" => "textfield",
            "heading" => __('OfferBox description:', 'rehub_framework'),
            "admin_label" => true,
            "param_name" => "description",
        ),   
		array(
			'type' => 'attach_image',
			'heading' => __('Offer thumbnail url', 'rehub_framework'),
			'param_name' => 'image_id',
			'value' => '',
		),                                   	                        
    )
...
vc_map( array(
    ...
    "params" => array(
		...
		array(
			"type" => "checkbox",
			"heading" => __('Disable box style in grid?', 'rehub_framework'),
			"value" => array(__("Yes", "rehub_framework") => true ),
