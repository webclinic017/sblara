<?php
	...
	define("EZSQL_DB_USER", "stock_sbcake2");			// <-- mysql db user
	define("EZSQL_DB_PASSWORD", "sbBangla@2010");		    // <-- mysql db password
	define("EZSQL_DB_NAME", "stock_sbcake");	            // <-- mysql db pname
