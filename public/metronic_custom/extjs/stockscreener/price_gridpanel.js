...
Ext.onReady(function () {
    var b = Ext.create("Ext.data.Store", {model: "DataObject", autoLoad: true, proxy: {type: "ajax", url: "{{ url('/ajax/data_matrix/') }}", reader: {type: "json", root: "pricedata"}}, sorters: {property: "sector", direction: "ASC"}, groupField: "sector", pageSize: 350});
    ...
    var d = Ext.create("Ext.grid.Panel", {height: 600, title: "Price Change Matrix", renderTo: "gridpanel", id: "pricematrix", store: b, viewConfig: {stripeRows: false}, features: [g, {ftype: "filters", local: true}], columns: [
